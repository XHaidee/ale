...
<section class="container py-lg-5">
  <!--User table-->
    <h1 class="">Here are the Users daily logs</h1>
    <div class="form-style-5">
      <button type="button" data-toggle="modal" style="background:#273f59 !important;" data-target="#Filter-export">Log Filter/ Export to Excel</button>
    </div>
    <!-- Log filter -->
